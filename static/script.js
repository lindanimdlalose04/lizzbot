class ChatApp {
        ...
        typingDiv.innerHTML = `
            <div class="message-avatar">
                <img src="/static/bot-icon.jpg" alt="Bot Avatar" 
                     onerror="this.onerror=null; this.style.display='none'; this.parentElement.innerHTML='<i class=\"fas fa-robot\"></i>';">
            </div>
    ...
    addMessage(content, sender, isError = false) {
        ...
        // For bot messages: remove emojis and clean up
        if (sender === 'bot' && !isError) {
            // Remove emojis
            messageContent = this.removeEmojis(messageContent);
            
            // Remove extra whitespace from short responses
        ...
        if (sender === 'user') {
            ...
            avatarHtml = '<img src="/static/bot-icon.jpg" alt="Bot Avatar" onerror="this.onerror=null; this.style.display=\'none\'; this.parentElement.innerHTML=\'<i class=\\"fas fa-robot\\"></i>\'">';
        }
        ...
        try {
            ...
            if (saved) {
                ...
                messages.forEach(msg => {
                    if (!msg.content.includes("Hello! I'm LizzBot")) {
